...
list progress using a REST API and saves it to acsv file.
...
The script makes a GET request to the REST API at 
'https://jsonplaceholder.typicode.com' to fetch the 
name of the employee
and all the tasks. It then counts the number of completed 
tasks for the given employee and outputs 
